...
\begin{document}
    \begin{tikzpicture}[node distance=2cm]
        ...
        \node (error-threshold-decision) [decision,below of=parameter-estimation, yshift=-1.2cm] { 6. $\delta > (1 - \eta) + \epsilon$?};
        ...
        \node (abort-decision) [decision,right of=measurement-of-quantum-states, xshift=4cm] { 7b. Abort?};
        ...
        \draw [arrow] (error-threshold-decision) -| node[anchor=south east] {No, Secret Key is not safe!}(abort-decision);
